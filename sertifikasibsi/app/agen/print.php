	...
	<table width="100%" border="0" cellspacing="0">
		<tr>
			...
			<td colspan="10" align="left">
				...
				<h1 style="margin-top: -20px;margin-left: -10px;" >PT. SPOWER-3</h1>
				<h5 style="margin-top: -20px;margin-left: -10px;">Jl. MAYOROKING No.25, Desa Ciriung Kec.Cibinong Kab.Bogor 16918</h5>
			</td>
		</tr>
