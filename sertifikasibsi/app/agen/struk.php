...
<body onload="window.print()"  style="font-family:monospace;" >
	<table style="background: url('../images/logo_login.jpg') center no-repeat;
			background-size: 50%;">
		<tr>
		...
		<tr>
			<td colspan="6" align="center">Rincian Tagihan dapat diakses di www.spower.co.id, Informasi Hubungi Call Center:123</td>
		</tr>
		<tr>
			<td colspan="6" align="center">PPOB SPOWER-3 PAYMENT/<?php echo $_SESSION['nama_agen']."/".$pembayaran['waktu_bayar']; ?></td>
		</tr>
	</table>
</body>
</html>