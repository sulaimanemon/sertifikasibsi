...
<body style="background:url('../images/logo_login.jpg');">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<div class="panel panel-primary">
						...
						<div class="panel-heading">
							<div style="margin-top: 5px;margin-bottom: 10px;">
								<img src="../images/logo_login.jpg" alt="logo" class="logo" width="100px">
							</div>
							<div style="margin-left: 110px; margin-top: -90px; font-size: 200%;">
